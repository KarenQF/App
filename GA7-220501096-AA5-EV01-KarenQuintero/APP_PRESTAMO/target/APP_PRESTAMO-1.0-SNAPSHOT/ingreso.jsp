...
<html lang="es">
    ...
    <main>
        ...
        <div class="grid-buttons">
            ...
            <button class="grid-button" onclick="redirectTo('gestion_reservas.jsp')">Gestión Reservas / Préstamos</button>
            <button class="grid-button" onclick="redirectTo('gestion_recursos.jsp')">Gestión Recursos Tecnológicos</button>
