...
<html lang="es">
    <head>
        ...
        <title>Registro Préstamo - Universidad del Valle</title>
...
<body>
    ...
    <div class="container">
        ...
        <form action="Svregistrar_prestamo" method="post">
            ...
            <input type="text" id="id_equipo" name="id_equipo" placeholder="id_equipo">
            
            <label for="fecha_prestamo">Fecha de Préstamo</label>
            <input type="date" id="fecha_prestamo" name="fecha_prestamo" placeholder="fecha_prestamo">

            <label for="hora_inicio_prestamo">Hora Inicio de Préstamo</label>
            <input type="time" id="hora_inicio_prestamo" name="hora_inicio_prestamo" placeholder="hora_inicio_prestamo">

            <label for="descripcion_actividad">Descripcion Actividad</label>
            <input type="text" id="descripcion_actividad" name="descripcion_actividad" placeholder="descripcion_actividad">
