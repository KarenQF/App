...
<html lang="es">
    <head>
        ...
        <title>Gestión de Reserva - Universidad del Valle</title>
    ...
    * {
    ...
    <main>
        <section class="gestion">
            ...
            <div class="gestion-header">
                <button class="btn-add" onclick="location.href= 'registrar_reserva.jsp'">Añadir Reserva</button>
            </div>
            <!-- Barra de búsqueda -->
            <div class="search-box">
                <form action="Svbuscar_reserva" method="get" class="search-container">
                    <input type="text" name="id_reserva" placeholder="🔍 Buscar reserva por ID..." required>
            ...
            %>
                    <div class="user-card">
                        <strong>ID Reserva: <%= r.get("id_reserva") %></strong><br>
                        <small>ID Usuario: <%= r.get("id_usuario") %></small><br>
                        <small>ID Equipo: <%= r.get("id_equipo") %></small><br>
                        <small>Fecha Reserva: <%= r.get("fecha_reserva") %></small><br>
                        <small>Hora Inicio: <%= r.get("hora_inicio_reserva") %></small><br>
                        <small>Hora Fin: <%= r.get("hora_fin_reserva") %></small><br>
                        <small>Estado: <%= r.get("estado_reserva") %></small><br><br>

                        <!-- Botones para editar y eliminar -->
                        <form action="Svobtener_reserva" method="get" style="display:inline;">
                            <input type="hidden" name="id_reserva" value="<%= r.get("id_reserva") %>">
                            <button type="submit" class="btn-edit"><i class="fas fa-edit"></i> Editar</button>
                        </form>

                        <form action="Sveliminar_reserva" method="post" style="display:inline;" onsubmit="return confirm('¿Estás segura de eliminar esta reserva?');">
                            <input type="hidden" name="id_reserva" value="<%= r.get("id_reserva") %>">
