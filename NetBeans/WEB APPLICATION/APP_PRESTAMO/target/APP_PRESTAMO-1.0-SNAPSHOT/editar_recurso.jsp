...
<html lang="es">
    ...
    * {
    ...
    <body>
        ...
        <form action="Svactualizar_recurso" method="post">
       
        <input type="hidden" name="id_equipo" value="${recurso.id_equipo}">
        <label>Número Inventario:</label>
        <input type="text" name="no_inventario" value="${recurso.no_inventario}" required>

        <label>Descripcion:</label>
        <input type="text" name="descripcion" value="${recurso.descripcion}" required>

        <label>Fecha de Adquisicion:</label>
        <input type="text" name="fecha_adquisicion" value="${recurso.fecha_adquisicion}" required>
        
        <label>Valor:</label>
        <input type="text" name="valor" value="${recurso.valor}" required>

        <label>Localización:</label>
        <select name="localizacion">    
            <option ${recurso.localizacion == 'Seleccione Opción' ? 'selected' : ''}>Seleccione Opción</option>
            <option ${recurso.localizacion == 'Villa Campestre' ? 'selected' : ''}>Villa Campestre</option>
            <option ${recurso.localizacion == 'Principe' ? 'selected' : ''}>Principe</option>
            <option ${recurso.localizacion == 'Victoria' ? 'selected' : ''}>Victoria</option>
        </select>

        <label>Estado de Equipo:</label>
        <select name="estado_equipo">
            <option ${recurso.estado_equipo == 'Seleccione Opción' ? 'selected' : ''}>Seleccione Opción</option>
            <option ${recurso.estado_equipo == 'Activo' ? 'selected' : ''}>Activo</option>
            <option ${recurso.estado_equipo == 'En reparación' ? 'selected' : ''}>En reparación</option>
            <option ${recurso.estado_equipo == 'Dado de baja' ? 'selected' : ''}>Dado de baja</option>
            <option ${recurso.estado_equipo == 'Prestado' ? 'selected' : ''}>Prestado</option>
        </select>
