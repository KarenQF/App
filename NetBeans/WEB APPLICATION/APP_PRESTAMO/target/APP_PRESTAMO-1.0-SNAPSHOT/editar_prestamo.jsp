...
<html lang="es">
    ...
    * {
    ...
    <body>
        ...
        <form action="Svactualizar_prestamo" method="post">
        <input type="hidden" name="id_prestamo" value="${prestamo.id_prestamo}">
        <input type="hidden" name="id_usuario" value="${prestamo.id_usuario}">
        <input type="hidden" name="id_equipo" value="${prestamo.id_equipo}">
        <label>Fecha de Préstamo:</label>
        <input type="text" name="fecha_prestamo" value="${prestamo.fecha_prestamo}" required>

        <label>Hora Inicio de Préstamo</label>
        <input type="text" name="hora_inicio_prestamo" value="${prestamo.hora_inicio_prestamo}" required>

        <label>Descripcion Actividad:</label>
        <input type="text" name="descripcion_actividad" value="${prestamo.descripcion_actividad}" required>

        <label>Estado de Préstamo:</label>
        <select name="estado_prestamo">     
            <option ${prestamo.estado_prestamo == 'Seleccione Opción' ? 'selected' : ''}>Seleccione Opción</option>
            <option ${prestamo.estado_prestamo == 'Activo' ? 'selected' : ''}>Activo</option>
            <option ${prestamo.estado_prestamo == 'Finalizado' ? 'selected' : ''}>Finalizado</option>
        </select>
