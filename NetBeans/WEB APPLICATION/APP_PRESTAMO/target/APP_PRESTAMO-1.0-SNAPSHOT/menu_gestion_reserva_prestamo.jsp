...
<html lang="es">
    ...
    <main>
        <div class="grid-buttons">
            <button class="grid-button" onclick="redirectTo('menu_gestion_reserva.jsp')">Reservas</button>
            <button class="grid-button" onclick="redirectTo('menu_gestion_prestamo.jsp')">Préstamos</button>
        </div>
