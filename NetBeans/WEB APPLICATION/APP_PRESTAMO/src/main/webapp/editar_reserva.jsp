...
<html lang="es">
    ...
    * {
    ...
    <body>
        ...
        <form action="Svactualizar_reserva" method="post">
        <input type="hidden" name="id_reserva" value="${reserva.id_reserva}">
        <input type="hidden" name="id_usuario" value="${reserva.id_usuario}">
        <input type="hidden" name="id_equipo" value="${reserva.id_equipo}">
        <label>Fecha de Reserva:</label>
        <input type="text" name="fecha_reserva" value="${reserva.fecha_reserva}" required>

        <label>Hora Inicio de Reserva</label>
        <input type="text" name="hora_inicio_reserva" value="${reserva.hora_inicio_reserva}" required>

        <label>Hora Fin Reserva:</label>
        <input type="text" name="hora_fin_reserva" value="${reserva.hora_fin_reserva}" required>

        <label>Estado de Reserva:</label>
        <select name="estado_reserva"> 
            <option ${reserva.estado_reserva == 'Seleccione Opción' ? 'selected' : ''}>Seleccione Opción</option>
            <option ${reserva.estado_reserva == 'Activo' ? 'selected' : ''}>Activo</option>
            <option ${reserva.estado_reserva == 'Finalizado' ? 'selected' : ''}>Finalizado</option>
        </select>
