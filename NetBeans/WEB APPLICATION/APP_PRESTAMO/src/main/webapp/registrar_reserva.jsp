...
<html lang="es">
    <head>
        ...
        <title>Registro Reserva - Universidad del Valle</title>
...
<body>
    ...
    <div class="container">
        ...
        <form action="Svregistrar_reserva" method="post">
            
            <!-- Campos de entrada -->
            <label for="id_usuario">Id Usuario</label>
            <input type="text" id="id_usuario" name="id_usuario" placeholder="Ingrese su id_usuario">

            <label for="id_equipo">Id Equipo</label>
            <input type="text" id="id_equipo" name="id_equipo" placeholder="Ingrese sU id_equipo">
            
            <label for="fecha_reserva">Fecha Reserva</label>
            <input type="date" id="fecha_reserva" name="fecha_reserva" placeholder="Ingrese la fecha_reserva">

            <label for="hora_inicio_reserva">Hora Inicio Reserva</label>
            <input type="time" id="hora_inicio_reserva" name="hora_inicio_reserva" placeholder="hora_inicio_reserva">

            <label for="hora_fin_reserva">Hora Fin Reserva</label>
            <input type="time" id="hora_fin_reserva" name="hora_fin_reserva" placeholder="hora_fin_reserva">
