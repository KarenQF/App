...
<html lang="es">
    <head>
        ...
        <title>Gestión de Recursos Tecnológicos - Universidad del Valle</title>
    ...
    <main>
        <section class="gestion">
            <div class="gestion-header">
                <h2>Gestión de Recursos Tecnológicos</h2>
            </div>
            <%
            ...
            <div class="gestion-header">
                <button class="btn-add" onclick="location.href= 'registrar_recurso.jsp'">Añadir Recursos Tecnológico</button>
            </div>
            <!-- Barra de búsqueda -->
            <div class="search-box">
                <form action="Svbuscar_recurso" method="get" class="search-container">
                    <input type="text" name="no_inventario" placeholder="🔍 Buscar por No. Inventario" required>
            ...
            <%
                List<Map<String, String>> recursos = (List<Map<String, String>>) request.getAttribute("recursos");
            ...
            <%
                ...
                for (Map<String, String> u : recursos) {
            %>
            
                    <div class="user-card">
                        <strong>No. Inventario:</strong> <%= u.get("no_inventario") %><br>
                        <small><strong>Descripción:</strong> <%= u.get("descripcion") %></small><br>
                        <small><strong>Fecha Adquisición:</strong> <%= u.get("fecha_adquisicion") %></small><br>
                        <small><strong>Valor:</strong> $<%= u.get("valor") %></small><br>
                        <small><strong>Localización:</strong> <%= u.get("localizacion") %></small><br>
                        <small><strong>Estado:</strong> <%= u.get("estado_equipo") %></small><br><br>

                        <form action="Svobtener_recurso" method="get" style="display:inline;">
                            <input type="hidden" name="id_equipo" value="<%= u.get("id_equipo") %>">
                            <button type="submit" class="btn-edit"><i class="fas fa-edit"></i> Editar</button>
                        </form>
                        <form action="Sveliminar_recurso" method="post" style="display:inline;" onsubmit="return confirm('¿Deseas eliminar este recurso?');">
                            <input type="hidden" name="id_equipo" value="<%= u.get("id_equipo") %>">
