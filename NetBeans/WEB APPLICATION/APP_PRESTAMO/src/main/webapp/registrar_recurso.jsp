...
<body>
    ...
    <main>
    <div class="container">
        <h2>Registro Recurso Tecnológico</h2>
        ...
        <form action="Svregistrar_recurso" method="post">
            
            <!-- Campos de entrada -->
            <label for="no_inventario">Número Inventario</label>
            <input type="text" id="no_inventario" name="no_inventario" placeholder="Ingrese el número de inventario">
            ...
            <input type="text" id="valor" name="valor" placeholder="Ingrese el valor">
...
<script>
    window.onload = function() {
        ...
        document.getElementById("fecha_adquisicion").value = fechaActual;
    };
</script>
